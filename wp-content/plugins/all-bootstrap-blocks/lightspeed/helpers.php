...
{
	$placeholder = get_option( 'areoi-lightspeed-company-stock-media', 'default' );
...
{	
	...
	if ( !$media && !$is_column && get_option( 'areoi-lightspeed-company-include-lightspeed', false ) && !lightspeed_item_icon( $item ) ) {
